...
const BlogLoading = () => {
  return (
    <div className="flex justify-center items-center p-10">
      <div
        role="status"
        class="p-4 border w-[48rem] h-[34rem] border-gray-200 rounded shadow animate-pulse md:p-6 dark:border-gray-700"
      >
        ...
        <div class="flex items-center justify-center h-72 mb-4 bg-gray-300 rounded dark:bg-gray-700">
          <svg
